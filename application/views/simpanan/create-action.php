                            ...
                            <div class="card-body">
                                ...
                                <div class="row">
                                    <div class="form-group col-12">
                                        ...
                                        <select name="id_jenis" class="custom-select <?= form_error('id_jenis') ? 'is-invalid' : 'is-valid'; ?>">
                                            <option value="">Pilih Jenis Simpanan</option>
                                            <?php foreach ($list_jenis as $j) { ?>
                                                <option <?= $input['id_jenis'] == $j->id ? 'selected' : ''; ?> value="<?= $j->id; ?>"><?= $j->jenis; ?></option>
                                            <?php } ?>
                                        </select>
                                        <div class="invalid-feedback">
                                ...
                                <div class="row">
                                    <div class="form-group col-12">
                                        ...
                                        <input type="date" class="custom-select <?= form_error('tgl_simpan') ? 'is-invalid' : 'is-valid'; ?>" name="tgl_simpan" id="tgl_simpan" value="<?php echo $input['tgl_simpan']; ?>" />
                                        <div class="invalid-feedback">
                                ...
                                <div class="row">
                                    <div class="form-group col-12">
                                        ...
                                        <input type="number" class="form-control <?= form_error('jumlah') ? 'is-invalid' : 'is-valid'; ?>" name="jumlah" id="jumlah" value="<?php echo $input['jumlah']; ?>" />
                                        <div class="invalid-feedback">
