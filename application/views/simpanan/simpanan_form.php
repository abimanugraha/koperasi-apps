...
<body>
    <h2 style="margin-top:0px">Simpanan <?php echo $button ?></h2>
    <form action="<?php echo $action; ?>" method="post">
        ...
        <div class="form-group">
            <label for="date">Tgl Simpan <?php echo form_error('tgl_simpan') ?></label>
            <input type="text" class="form-control" name="tgl_simpan" id="tgl_simpan" placeholder="Tgl Simpan" value="<?php echo $tgl_simpan; ?>" />
        </div>
        <div class="form-group">
