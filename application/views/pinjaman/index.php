...
<div class="main-content">
    <section class="section">
        ...
        <div class="section-body">
            <h2 class="section-title">Pinjaman</h2>
            <?php echo $this->session->userdata('message'); ?>
            <div class="row">
                <div class="col-12">
                    <div class="card">
                        <div class="card-header">
                            <a href="<?= base_url('pinjaman/create'); ?>" class="btn btn-icon icon-left btn-primary"><i class="fas fa-plus"></i> Tambah Pinjaman</a>
                            <h4 hidden>Daftar Pinjaman</h4>
