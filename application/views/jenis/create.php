                            ...
                            <div class="card-body">
                                <div class="row">
                                    <div class="form-group col-12">
                                        ...
                                        <input type="text" class="form-control <?= form_error('jenis') ? 'is-invalid' : ''; ?>" name="jenis" id="jenis" placeholder="Jenis Simpanan" value="<?php echo $input['jenis']; ?>" />
                                ...
                                <div class="row">
                                    <div class="form-group col-12">
                                        ...
                                        <textarea rows="4" type="text" class="form-control <?= form_error('keterangan') != null ? 'is-invalid' : ''; ?>" name="keterangan" id="keterangan" placeholder="Keterangan"><?php echo $input['keterangan']; ?></textarea>
                                        <div class="invalid-feedback">
