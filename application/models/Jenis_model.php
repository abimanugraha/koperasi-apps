...
class Jenis_model extends CI_Model
{
    ...
    // datatables
    function json() {
        $this->datatables->select('id,jenis,keterangan');
        $this->datatables->from('jenis');
        //add this line for join
        //$this->datatables->join('table2', 'jenis.field = table2.field');
        $this->datatables->add_column('action', anchor(site_url('jenis/read/$1'),'Read')." | ".anchor(site_url('jenis/update/$1'),'Update')." | ".anchor(site_url('jenis/delete/$1'),'Delete','onclick="javasciprt: return confirm(\'Are You Sure ?\')"'), 'id');
